				...
				if ( have_posts() ) :
					while ( have_posts() ) : the_post(); ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'module single-post-module' ); ?>>
							...
							<div class="post-header">
								...
								<div class="post-meta vcard">
									<p><?php echo extra_child_display_single_post_meta(); ?></p>
								</div>
							</div>
							<?php } ?>
						...
						<div class="et_extra_other_module author-box vcard">
                            <?php if (function_exists('get_multiple_authors')) : ?>
                                <?php $authors = get_multiple_authors(); ?>

                                <div class="author-box-header">
                                    <h3><?php echo (count($authors) > 1) ? esc_html_e( 'About The Authors', 'extra' ) : esc_html_e( 'About The Author', 'extra' ); ?></h3>
                                </div>
                                <?php foreach ($authors as $author) : ?>
                                    <div class="author-box-content clearfix">
                                        <div class="author-box-avatar">
                                            <?php echo $author->get_avatar(170); ?>
                                        </div>
                                        <div class="author-box-description">
                                            <h4><a class="author-link url fn" href="<?php echo $author->link; ?>" rel="author" title="<?php printf( et_get_safe_localization( __( 'View all posts by %s', 'extra' ) ), $author->display_name ); ?>"><?php echo $author->display_name; ?></a></h4>
                                            <p class="note"><?php echo $author->description; ?></p>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else : ?>
